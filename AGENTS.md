# Living Room Lobby: party games for a smart-TV browser where kids without phones and non-English relatives can still play (`living-room-lobby`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://living-room-lobby.sociobot.in`. Artifact class: `web-with-backend`.
